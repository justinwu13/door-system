...
void I2C_Initialization(void){
	...
	RCC->CCIPR |= RCC_CCIPR_I2C1SEL_0; // set to SYSCLK (01)
	...
	I2C1->TIMINGR |= 7UL << I2C_TIMINGR_PRESC_POS; // sets freq to 10 MHz, t = 100 ns
	I2C1->TIMINGR |= 9UL << I2C_TIMINGR_SCLDEL_POS; // t_SCLDEL = 1000 ns
	I2C1->TIMINGR |= 12UL << I2C_TIMINGR_SDADEL_POS; // t_SDADEL = 1300 ns
	I2C1->TIMINGR |= 39UL << I2C_TIMINGR_SCLH_POS; // t_SCLH = 4.0 us = 4000 ns
	I2C1->TIMINGR |= 46UL << I2C_TIMINGR_SCLL_POS; // t_SCLL = 4.7 us = 4700 ns
